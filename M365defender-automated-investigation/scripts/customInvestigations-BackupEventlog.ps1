...
BEGIN
{
    $targetCompressedFilePath = $baseDirectory + "\" + "eventlogs"
}
PROCESS
{
    ...
    Compress-Archive -Path $targetCompressedFilePath -DestinationPath $targetCompressedFilePath -CompressionLevel Optimal -Force
